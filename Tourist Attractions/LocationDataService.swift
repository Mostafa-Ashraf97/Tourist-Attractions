...
class LocationsDataService {
    ...
    static let locations: [Location] = [
        ...
        Location(name: "The Leaning Tower of Pisa", cityName: "Pisa", coordinates: CLLocationCoordinate2D(latitude: 43.7230, longitude: 10.3966), description: "The Leaning Tower of Pisa, or simply the Tower of Pisa, is the campanile, or freestanding bell tower, of Pisa Cathedral. It is known for its nearly four-degree lean, the result of an unstable foundation.", imageNames: ["pisa-1", "pisa-2"], link: "https://en.wikipedia.org/wiki/Leaning_Tower_of_Pisa")
    ]
